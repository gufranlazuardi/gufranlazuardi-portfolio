        ...
        <div className="flex gap-7 justify-center mt-10">
          <div className="flex flex-col items-center gap-4">
            <div className="flex flex-col border rounded-md px-4 py-4 gap-2 max-w-6xl bg-slate-100">
              ...
              <p className="text-sm">
                • Implemented strategies to unmerge hotels with similar titles
                at identical location points, optimizing the clarity and
                accuracy of our hotel listings
              </p>
              <p className="text-sm">
                • Keeping Tiket.com competitive by dynamically updating top
                hotel prices based on market adjustments, ensuring alignment
            ...
            <div className="flex flex-col border rounded-md  px-4 py-4 gap-2 max-w-6xl bg-slate-100">
              ...
              <p className="text-sm">
                ...
                encompassing Paket ID, Stock Transfer Order (STO), Purchase
                Order (PO), and Facture. Executed seamless uploads to Google
                Data Studio for comprehensive insights
              </p>
              <p className="text-sm">
              ...
              <p className="text-sm">
                ...
                repurchase in cases where stock was unavailable at branch
                offices. Monitoredthe stock tracking process to prevent
                indentations and facilitated efficient delivery tracking
              </p>
              <p className="text-sm">
                • Implemented a proactive approach to follow up on outstanding
                or pending stock at various stakeholders, guaranteeing the
                smooth and timely distribution of stocks
              </p>
            </div>
          </div>
        </div>
